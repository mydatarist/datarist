        ...
        <header className="p-3 mb-3 border-bottom">
          <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <Link href="https://datarist.com/" className="d-flex align-items-center mb-2 mb-lg-0 link-body-emphasis text-decoration-none">
              <Image src="/brand/logo.svg" alt="Datarist logo"  className="bi me-2" width="36" height="28" aria-label="Datarist"/>
            ...
            <div className="text-end">
              ...
              <Link href="https://datarist.com/sign-up/"><button type="button" className="btn btn-outline-dark">Sign up</button></Link>
            </div>
          </div>
        </header> 
        {children} 
